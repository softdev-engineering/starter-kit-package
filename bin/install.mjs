...
if (process.argv.length < 3) {
  ...
  console.log("    npx softdev-starter-kit my-app");
  process.exit(1);
}
...
const git_repo = "git@github.com:softdev-engineering/softdev-starter-kit.git";
...
try {
  ...
  // Update the package.json file with the new project name
